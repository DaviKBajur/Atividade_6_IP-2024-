...
float CalculoDoProdutoEscalarDosVetores(float vetor1[], float vetor2[], int tam_vetor){
...
int main(int argv, char ** argc){
    ...
    float vetor1[tam_vetor], vetor2[tam_vetor];
    ...
    printf("Resultado: ");
    PRINTF("%.2f", CalculoDoProdutoEscalarDosVetores(vetor1, vetor2, tam_vetor));
    printf("\n");
